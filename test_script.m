...
SIM.T_step = 0.1;
SIM.Tsim = 110;  %Sim time in seconds
...
for t = DATA.T_vec
    ...
    SIM.done = false;
    if t>50 && t<68
        CONTROL.input_vec = CONTROL.input_vec + [0.00, 0.0002];
    elseif t>68 && t<85
        CONTROL.input_vec = CONTROL.input_vec + [0.01, -0.0002];
    else
        CONTROL.input_vec(2) = 0;
        CONTROL.input_vec = CONTROL.input_vec + [0.02, 0.0];
    end
